...
#### EC2 mattermost main ####
resource "aws_security_group" "ec2_mattermost_main" {
  name = local.ec2_mattermost_main_name

  description = "Main security group for EC2 ${local.ec2_mattermost_main_name} instance"
  vpc_id      = module.vpc.vpc_id
...
# Egress rule #
resource "aws_security_group_rule" "ec2_mattermost_main_egress_1" {
  description       = "[T] Allow access from EC2 instance: ${local.ec2_mattermost_main_name}"
  security_group_id = aws_security_group.ec2_mattermost_main.id
...
# Ingress rule #
resource "aws_security_group_rule" "ec2_mattermost_main_ingress_1" {
  description       = "[T] Allow HTTPS to EC2 instance: ${local.ec2_mattermost_main_name}"
  security_group_id = aws_security_group.ec2_mattermost_main.id
...
resource "aws_security_group_rule" "ec2_mattermost_main_ingress_2" {
  description       = "[T] Allow HTTP to EC2 instance: ${local.ec2_mattermost_main_name}"
  security_group_id = aws_security_group.ec2_mattermost_main.id
...
resource "aws_security_group_rule" "ec2_mattermost_main_ingress_3" {
  description       = "[T] Allow Websocket to EC2 instance: ${local.ec2_mattermost_main_name}"
  security_group_id = aws_security_group.ec2_mattermost_main.id
...
resource "aws_security_group_rule" "ec2_mattermost_main_ingress_4" {
  description       = "[T] Allow access from VPN to EC2 instance: ${local.ec2_mattermost_main_name}"
  security_group_id = aws_security_group.ec2_mattermost_main.id
